    ...
    <section class="ftco-section ftco-degree-bg services-section img mx-md-5" style="background-image: url(images/bg_2.jpg);">
    	...
    	<div class="container">
          ...
          <div class="col-md-6 text-center heading-section heading-section-white ftco-animate">
            ...
            <h2 class="mb-3">Как пользоваться приложением</h2>
          </div>
        </div>
    		<div class="row">
    			<div class="col-md-6">
		            ...
		            <div class="media block-6 services services-2">
		              <div class="media-body py-md-4 text-center">
		                ...
		                <h3>Открыть страницу “Начать поиск”</h3>
		                <p>Она находится в шапке сайта</p>
		              </div>
		            </div>      
		          </div>
		          <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
		            <div class="media block-6 services services-2">
		              <div class="media-body py-md-4 text-center">
		                ...
		                <h3>Выбрать необходимый вариант поиска</h3>
		                <p>1. Выбор гостиницы <br>2. Выбор достопримечательностей</p>
		              </div>
		            </div>      
		          </div>
		          <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
		            <div class="media block-6 services services-2">
		              <div class="media-body py-md-4 text-center">
		                ...
		                <h3>Выбрать нужную категорию культурных учреждений в Санкт-Петербурге</h3>
		                <p>1. Достопримечательности <br>2. Музеи</p>
		              </div>
		            </div>      
		          </div>
		          <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
		            <div class="media block-6 services services-2">
		              <div class="media-body py-md-4 text-center">
		                ...
		                <h3>Нажать кнопку “Начать поиск”</h3>
		                <p>Готово!</p>
		              </div>
		            </div>      
		          </div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Помощь</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
